...
param(
    ...
    # Classic = existing Windows Consumption/Premium/Dedicated flow (default, backwards compatible).
    ...
    # App Service Plan Parameters (OPTIONAL - Classic: creates Consumption plan if omitted; Flex: names the Flex plan)
    [Parameter(Mandatory = $false)]
...
if ($isFlexConsumption) {
    ...
    Write-Host "Hosting plan: Classic (default Consumption / existing ASP)"
}
